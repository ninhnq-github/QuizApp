...
@WebServlet(name = "AddQuestionServlet", value = "/AddQuestion")
public class AddQuestionServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<BankEntity> mlistBank = BankEntity.getAll();
        System.out.println(mlistBank.size()+"-----------------------------------------------------------");
        request.setAttribute("mlistBank",mlistBank);
